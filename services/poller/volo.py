...
def build_request_body(now: datetime, limit: int = 100) -> dict:
    """Open flag football drop-ins in NYC that start after `now`."""
    where = {
        "_and": [
            ...
            {"game_id": {"_is_null": False}},
            {
                "game": {
                    ...
                    "leagueByLeague": {
                        ...
                        "archived": {"_eq": False},
                        "private": {"_eq": False},
                        "sportBySport": {"_id": {"_eq": FLAG_FOOTBALL_SPORT_ID}},
                    },
                }
            },
        ]
